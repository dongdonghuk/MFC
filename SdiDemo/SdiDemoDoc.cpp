...
// SdiDemoDoc.cpp: CSdiDemoDoc 클래스의 구현
//
...
CSdiDemoDoc::CSdiDemoDoc() noexcept
{
...
BOOL CSdiDemoDoc::OnNewDocument()
{
	...
	TRACE("BOOL CSdiDemoDoc::OnNewDocument()~~~~~~~~~~~~~~~~~~~~~~~~ a = %d, b = %d \n", pApp->m_a, pApp->m_b);


	CMainFrame* pMainFrame = (CMainFrame*)AfxGetMainWnd();
	if (pMainFrame != nullptr) {
		TRACE("BOOL CSdiDemoDoc::OnNewDocument()~~~~~~~~~~~ e = %d, f = %d \n", pMainFrame->m_e, pMainFrame->m_f);
	}
