...
BEGIN_MESSAGE_MAP(Cstep7View, CView)
	// 표준 인쇄 명령입니다.
...
int Cstep7View::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndClient1.Create(TEXT("STATIC"), TEXT("DEMO"),
						WS_CHILD | WS_VISIBLE | WS_BORDER,
						CRect(30, 30, 180, 180), this, 1234);

	m_wndClient2.Create(TEXT("EDIT"), TEXT("DEMO"),
						WS_CHILD | WS_VISIBLE | WS_BORDER,
						CRect(230, 30, 380, 180), this, 1);

	m_wndClient3.Create(TEXT("STATIC"), TEXT("DEMO"),
						WS_CHILD | WS_VISIBLE | WS_BORDER,
